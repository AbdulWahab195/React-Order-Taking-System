...
class BillingForm extends Component {
    ...
    handleSubmit = e => {
        ...
        const { onCancel, addAddress, customer } = this.props;
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            ...
            data.customer.addresses.push(addressObj);
            if (!err) {
                addAddress(data, customer.id);
                onCancel();
            }
        });
    };
...
const billingForm = Form.create({ name: "address_create" })(BillingForm);
